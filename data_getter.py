...
class WikiBot:
    ...
    def __init__(self):
        ...
        options.add_experimental_option('prefs', {
            "download.default_directory": "~/ProgrammingProjects/SummerHackathon/PDF_Files", #Change default directory for downloads keep in mind it will be different for each persons directory
